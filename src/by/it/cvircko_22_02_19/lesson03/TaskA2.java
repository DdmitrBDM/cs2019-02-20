...
class TaskA2 {
    public static void main(String[] args) {
        String a = ("Здравствуй,чудовище,снова пишу тебе.");
        String b = ("Ты там не мерзнешь в моей ледяной пустыне?");
        String c = ("Я вычисляю из функции жизни предел:");
        String d = ("Как и когда твое сердце навечно застынет.");
